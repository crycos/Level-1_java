...
public class CancellationError {
	public static void main(String[] args) {
		...
		// Display results of first computation
		System.out.println("Left computation is: " + sum);
		
		// Second computation
		for (double i = 50000.0; i <= 1; i--) {
			sum += 1/i;
		}
		// Display results of second computation
		System.out.println("Right computation is: " + sum);
		}
	}
