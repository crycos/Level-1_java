// Exercise 6.31 (Financial: credit card number validation) on page 241
...
public class CreditCardValidation {
	public static void main(String[] args) {
		...
		public static boolean isValid(long number) {
			boolean valid = (getSize(number) >= 13 && getSize(number) <= 16) && (prefixMatched(number, 4) || prefixMatched(number, 5) || 
